...
;['classList', 'style', 'dataset', 'childNodes', 'children', 'firstElementChild', 'lastElementChild', 'firstChild', 'lastChild'].forEach(entry => {
  Object.defineProperty(Dollar.prototype, entry, {
    get: function() {
      return this.el[entry]
    }
...
;['addEventListener', 'removeEventListener', 'remove', 'matches', 'blur', 'focus'].forEach(entry => {
  Object.defineProperty(Dollar.prototype, entry, {
    value: function() {
