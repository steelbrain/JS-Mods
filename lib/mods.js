...
;['addEventListener', 'removeEventListener', 'remove', 'matches', 'blur', 'focus', 'getAttribute', 'setAttribute', 'hasAttribute', 'removeAttribute', 'dispatchEvent', 'hasChildNodes'].forEach(entry => {
  Object.defineProperty(Dollar.prototype, entry, {
    value: function() {
